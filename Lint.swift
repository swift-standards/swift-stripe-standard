...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-stripe-types open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-stripe-types project authors
