//
//  Stripe Customer Session Types Client Errors.swift
...
extension Stripe.Customers.Customer.Sessions.Create {
    /// Failure leaf for `Stripe.Customers.Customer.Sessions.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Customers.Customer.Session } }`.
