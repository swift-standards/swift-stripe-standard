...
extension Stripe.Terminal.Readers {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: Create.Request) async throws(any Swift.Error) -> Reader
        ...
        public var update:
            @Sendable (_ id: Reader.ID, _ request: Update.Request) async throws(any Swift.Error) ->
                Reader
        ...
        public var delete:
            @Sendable (_ id: Reader.ID) async throws(any Swift.Error) -> DeletedObject<Reader>
        ...
        public var collectInputs:
            @Sendable (_ id: Reader.ID, _ request: CollectInputs.Request) async throws(any Swift
                .Error) -> Reader
        ...
        public var refundPayment:
            @Sendable (_ id: Reader.ID, _ request: RefundPayment.Request) async throws(any Swift
                .Error) -> Reader
