//
//  Stripe Terminal Reader Types Client Errors.swift
...
extension Stripe.Terminal.Readers.Create {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Reader`.
...
extension Stripe.Terminal.Readers.Retrieve {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.Update {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.List {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.Delete {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.delete`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered with a structured API error.
        case api(StripeError.Error)
        /// Stripe answered, but the payload did not decode as `DeletedObject<Reader>`.
        case malformedResponse
        /// The witness carries no implementation for this operation.
        case notImplemented(Witness.Unimplemented.Error)
...
extension Stripe.Terminal.Readers {
    /// Namespace for the `cancelAction` operation.
    public enum CancelAction {}
}

extension Stripe.Terminal.Readers.CancelAction {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.cancelAction`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.ProcessPaymentIntent {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.processPaymentIntent`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.ProcessSetupIntent {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.processSetupIntent`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.CollectInputs {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.collectInputs`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.ConfirmPaymentIntent {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.confirmPaymentIntent`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.CollectPaymentMethod {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.collectPaymentMethod`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.RefundPayment {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.refundPayment`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.SetReaderDisplay {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.setReaderDisplay`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Terminal.Readers.PresentPaymentMethod {
    /// Failure leaf for `Stripe.Terminal.Readers.Client.presentPaymentMethod`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
