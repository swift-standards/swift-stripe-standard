//
//  Stripe Disputes Types Client Errors.swift
...
extension Stripe.Disputes.Retrieve {
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Disputes.Dispute`.
...
extension Stripe.Disputes.List {
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered with a structured API error.
        case api(StripeError.Error)
        /// Stripe answered, but the payload did not decode as `Stripe.Disputes.List.Response`.
        case malformedResponse
        /// The witness carries no implementation for this operation.
        case notImplemented(Witness.Unimplemented.Error)
...
extension Stripe.Disputes {
    /// Namespace for the `close` operation.
    public enum Close {}
}

extension Stripe.Disputes.Close {
