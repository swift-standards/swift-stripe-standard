//
//  Stripe Payment Methods Sources Types Client Errors.swift
...
extension Stripe.PaymentMethods.Sources.Create {
    /// Failure leaf for `Stripe.PaymentMethods.Sources.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe_Types_Models.Source`.
...
extension Stripe.PaymentMethods.Sources.Retrieve {
    /// Failure leaf for `Stripe.PaymentMethods.Sources.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethods.Sources.Update {
    /// Failure leaf for `Stripe.PaymentMethods.Sources.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethods.Sources {
    /// Namespace for the `attach` operation.
    public enum Attach {}
}

extension Stripe.PaymentMethods.Sources.Attach {
    /// Failure leaf for `Stripe.PaymentMethods.Sources.Client.attach`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethods.Sources.Detach {
    /// Failure leaf for `Stripe.PaymentMethods.Sources.Client.detach`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
