//
//  Stripe Payment Method Configurations Types Client Errors.swift
...
extension Stripe.PaymentMethodConfigurations.Create {
    /// Failure leaf for `Stripe.PaymentMethodConfigurations.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.PaymentMethodConfigurations.Configuration`.
...
extension Stripe.PaymentMethodConfigurations.Retrieve {
    /// Failure leaf for `Stripe.PaymentMethodConfigurations.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethodConfigurations.Update {
    /// Failure leaf for `Stripe.PaymentMethodConfigurations.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethodConfigurations.List {
    /// Failure leaf for `Stripe.PaymentMethodConfigurations.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
