//
//  Stripe Payment Method Domains Types Client Errors.swift
...
extension Stripe.PaymentMethodDomains.Create {
    /// Failure leaf for `Stripe.PaymentMethodDomains.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.PaymentMethodDomain`.
...
extension Stripe.PaymentMethodDomains.Retrieve {
    /// Failure leaf for `Stripe.PaymentMethodDomains.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethodDomains.Update {
    /// Failure leaf for `Stripe.PaymentMethodDomains.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethodDomains.List {
    /// Failure leaf for `Stripe.PaymentMethodDomains.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.PaymentMethodDomains {
    /// Namespace for the `validate` operation.
    public enum Validate {}
}

extension Stripe.PaymentMethodDomains.Validate {
    /// Failure leaf for `Stripe.PaymentMethodDomains.Client.validate`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
