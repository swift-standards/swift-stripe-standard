...
extension Stripe.WebhookEndpoint {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: Stripe.WebhookEndpoint.Create.Request) async throws(any Swift
                .Error) -> Webhook

        // https://docs.stripe.com/api/webhook_endpoints/retrieve.md
        public var retrieve:
            @Sendable (_ id: Stripe.WebhookEndpoint.ID) async throws(any Swift.Error) -> Webhook
        ...
        public var list:
            @Sendable (_ request: Stripe.WebhookEndpoint.List.Request) async throws(any Swift.Error)
                -> List.Response

        // https://docs.stripe.com/api/webhook_endpoints/delete.md
        public var delete:
            @Sendable (_ id: Stripe.WebhookEndpoint.ID) async throws(any Swift.Error) ->
                DeletedObject<
