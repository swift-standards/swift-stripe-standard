...
extension Stripe.Refunds {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: Stripe.Refunds.Create.Request) async throws(any Swift.Error) ->
        ...
        public var update:
            @Sendable (_ id: Stripe.Refunds.Refund.ID, _ request: Stripe.Refunds.Update.Request)
                async throws(any Swift.Error) -> Stripe.Refunds.Refund

        // https://docs.stripe.com/api/refunds/list.md
        public var list:
            @Sendable (_ request: Stripe.Refunds.List.Request) async throws(any Swift.Error) ->
