//
//  Stripe Balance Types Client Errors.swift
...
extension Stripe.Balance.Retrieve {
    /// Failure leaf for `Stripe.Balance.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Balance } }`.
