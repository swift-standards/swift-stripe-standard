...
extension Stripe.PaymentIntents {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: Stripe.PaymentIntents.Create.Request) async throws(any Swift
                .Error) ->
        ...
        public var search:
            @Sendable (_ request: Stripe.PaymentIntents.Search.Request) async throws(any Swift
                .Error) ->
