//
//  Stripe Setup Attempts Types Client Errors.swift
...
extension Stripe.Setup.Attempts.List {
    /// Failure leaf for `Stripe.Setup.Attempts.Client.list`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Setup.Attempts.List.Response } }`.
