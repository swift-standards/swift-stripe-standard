...
extension Stripe.Forwarding.Request {
    ...
    public struct Client: Sendable {
        ...
        public var retrieve:
            @Sendable (_ id: Stripe.Forwarding.Request.ID) async throws(any Swift.Error) ->
                Stripe.Forwarding.Request

        // https://docs.stripe.com/api/forwarding/request/list.md
        public var list:
            @Sendable (_ request: Stripe.Forwarding.Request.List.Request) async throws(any Swift
                .Error) ->
