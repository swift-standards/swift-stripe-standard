//
//  Stripe Products Tax Rate Types Client Errors.swift
...
extension Stripe.Products.TaxRates.Create {
    /// Failure leaf for `Stripe.Products.TaxRates.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Tax.Rate`.
...
extension Stripe.Products.TaxRates.Retrieve {
    /// Failure leaf for `Stripe.Products.TaxRates.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Products.TaxRates.Update {
    /// Failure leaf for `Stripe.Products.TaxRates.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Products.TaxRates.List {
    /// Failure leaf for `Stripe.Products.TaxRates.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
