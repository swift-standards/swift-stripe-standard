...
extension Stripe.Products.Prices {
    ...
    public struct Client: Sendable {
        public var create:
            @Sendable (_ request: Stripe.Products.Prices.Create.Request) async throws(any Swift
                .Error) ->
        ...
        public var retrieve:
            @Sendable (_ id: Stripe.Products.Price.ID) async throws(any Swift.Error) ->
                Stripe.Products.Price
        ...
        public var search:
            @Sendable (_ request: Stripe.Products.Prices.Search.Request) async throws(any Swift
                .Error) ->
