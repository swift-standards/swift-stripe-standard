//
//  Stripe Products Promotion Code Types Client Errors.swift
...
extension Stripe.Products.PromotionCodes.Create {
    /// Failure leaf for `Stripe.Products.PromotionCodes.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Promotion.Code`.
...
extension Stripe.Products.PromotionCodes.Retrieve {
    /// Failure leaf for `Stripe.Products.PromotionCodes.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Products.PromotionCodes.Update {
    /// Failure leaf for `Stripe.Products.PromotionCodes.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Products.PromotionCodes.List {
    /// Failure leaf for `Stripe.Products.PromotionCodes.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
