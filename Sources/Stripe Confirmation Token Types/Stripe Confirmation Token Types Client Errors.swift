//
//  Stripe Confirmation Token Types Client Errors.swift
...
extension Stripe.Retrieve {
    /// Failure leaf for `Stripe.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe_Types_Models.ConfirmationToken } }`.
