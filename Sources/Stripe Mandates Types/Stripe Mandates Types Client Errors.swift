//
//  Stripe Mandates Types Client Errors.swift
...
extension Stripe.Mandates.Retrieve {
    /// Failure leaf for `Stripe.Mandates.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Mandates.Mandate } }`.
