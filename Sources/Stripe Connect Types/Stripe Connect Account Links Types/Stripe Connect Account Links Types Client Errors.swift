//
//  Stripe Connect Account Links Types Client Errors.swift
...
extension Stripe.Connect.AccountLinks.Create {
    /// Failure leaf for `Stripe.Connect.AccountLinks.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Connect.Account.Link } }`.
