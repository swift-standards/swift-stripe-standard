//
//  Stripe Connect Transfer Reversals Types Client Errors.swift
...
extension Stripe.Connect.Transfer.Reversals.Create {
    /// Failure leaf for `Stripe.Connect.Transfer.Reversals.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Connect.Transfer.Reversal`.
...
extension Stripe.Connect.Transfer.Reversals.Retrieve {
    /// Failure leaf for `Stripe.Connect.Transfer.Reversals.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Connect.Transfer.Reversals.Update {
    /// Failure leaf for `Stripe.Connect.Transfer.Reversals.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Connect.Transfer.Reversals.List {
    /// Failure leaf for `Stripe.Connect.Transfer.Reversals.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
