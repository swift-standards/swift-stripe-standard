//
//  Stripe Early Fraud Warnings Types Client Errors.swift
...
extension Stripe.Fraud.EarlyFraudWarnings.Retrieve {
    /// Failure leaf for `Stripe.Fraud.EarlyFraudWarnings.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `EarlyFraudWarning`.
...
extension Stripe.Fraud.EarlyFraudWarnings.List {
    /// Failure leaf for `Stripe.Fraud.EarlyFraudWarnings.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
