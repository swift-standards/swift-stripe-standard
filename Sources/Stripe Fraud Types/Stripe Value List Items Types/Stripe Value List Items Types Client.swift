...
extension Stripe.Fraud.ValueListItems {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: API.Create.Request) async throws(any Swift.Error) -> ValueListItem

        // https://docs.stripe.com/api/radar/value_list_items/retrieve.md
        public var retrieve:
            @Sendable (_ id: ValueListItem.ID) async throws(any Swift.Error) -> ValueListItem
        ...
        public var delete:
            @Sendable (_ id: ValueListItem.ID) async throws(any Swift.Error) -> DeletedObject<
                ValueListItem
            >
    }
}
