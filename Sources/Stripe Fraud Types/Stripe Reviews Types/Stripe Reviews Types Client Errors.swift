//
//  Stripe Reviews Types Client Errors.swift
...
extension Stripe.Fraud.Reviews.Retrieve {
    /// Failure leaf for `Stripe.Fraud.Reviews.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Review`.
...
extension Stripe.Fraud.Reviews {
    /// Namespace for the `list` operation.
    public enum List {}
}

extension Stripe.Fraud.Reviews.List {
    /// Failure leaf for `Stripe.Fraud.Reviews.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Fraud.Reviews {
    /// Namespace for the `approve` operation.
    public enum Approve {}
}

extension Stripe.Fraud.Reviews.Approve {
    /// Failure leaf for `Stripe.Fraud.Reviews.Client.approve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
