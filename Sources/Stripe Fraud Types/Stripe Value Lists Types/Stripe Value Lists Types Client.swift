...
extension Stripe.Fraud.ValueLists {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: API.Create.Request) async throws(any Swift.Error) -> ValueList

        // https://docs.stripe.com/api/radar/value_lists/retrieve.md
        public var retrieve:
            @Sendable (_ id: ValueList.ID) async throws(any Swift.Error) -> ValueList

        // https://docs.stripe.com/api/radar/value_lists/update.md
        public var update:
            @Sendable (_ id: ValueList.ID, _ request: API.Update.Request) async throws(any Swift
                .Error) -> ValueList
        ...
        public var delete:
            @Sendable (_ id: ValueList.ID) async throws(any Swift.Error) -> DeletedObject<ValueList>
    }
}
