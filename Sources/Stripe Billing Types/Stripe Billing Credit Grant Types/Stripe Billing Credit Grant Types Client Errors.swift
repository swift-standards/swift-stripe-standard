//
//  Stripe Billing Credit Grant Types Client Errors.swift
...
extension Stripe.Billing.Credit.Grant.Create {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Billing.Credit.Grant`.
...
extension Stripe.Billing.Credit.Grant.Retrieve {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Credit.Grant.Update {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Credit.Grant.List {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Credit.Grant.Expire {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.expire`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Credit.Grant.Void {
    /// Failure leaf for `Stripe.Billing.Credit.Grant.Client.void`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
