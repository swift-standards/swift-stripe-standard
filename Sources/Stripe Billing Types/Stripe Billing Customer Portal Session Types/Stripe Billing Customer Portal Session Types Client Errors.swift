//
//  Stripe Billing Customer Portal Session Types Client Errors.swift
...
extension Stripe.Billing.Customer.Portal.Session.Create {
    /// Failure leaf for `Stripe.Billing.Customer.Portal.Session.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Billing.Customer.Portal.Session`.
