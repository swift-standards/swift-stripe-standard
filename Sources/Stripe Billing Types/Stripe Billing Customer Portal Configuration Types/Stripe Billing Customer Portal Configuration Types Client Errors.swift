//
//  Stripe Billing Customer Portal Configuration Types Client Errors.swift
...
extension Stripe.Billing.Customer.Portal.Configuration.Create {
    /// Failure leaf for `Stripe.Billing.Customer.Portal.Configuration.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Billing.Customer.Portal.Configuration`.
...
extension Stripe.Billing.Customer.Portal.Configuration.Retrieve {
    /// Failure leaf for `Stripe.Billing.Customer.Portal.Configuration.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Customer.Portal.Configuration.Update {
    /// Failure leaf for `Stripe.Billing.Customer.Portal.Configuration.Client.update`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.Customer.Portal.Configuration.List {
    /// Failure leaf for `Stripe.Billing.Customer.Portal.Configuration.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
