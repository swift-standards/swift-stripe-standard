//
//  Stripe Billing Credit Balance Summary Types Client Errors.swift
...
extension Stripe.Billing.CreditBalanceSummary.Retrieve {
    /// Failure leaf for `Stripe.Billing.CreditBalanceSummary.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Billing.Credit.Balance.Summary } }`.
