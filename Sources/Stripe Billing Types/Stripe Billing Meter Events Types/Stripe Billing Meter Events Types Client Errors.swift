//
//  Stripe Billing Meter Events Types Client Errors.swift
...
extension Stripe.Billing.MeterEvents.Create {
    /// Failure leaf for `Stripe.Billing.MeterEvents.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `MeterEvent } }`.
