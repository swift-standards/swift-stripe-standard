//
//  Stripe Billing Meter Event Adjustment Types Client Errors.swift
...
extension Stripe.Billing.MeterEventAdjustments.Create {
    /// Failure leaf for `Stripe.Billing.MeterEventAdjustments.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `MeterEventAdjustment } }`.
