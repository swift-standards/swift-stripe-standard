//
//  Stripe Billing Credit Balance Transaction Types Client Errors.swift
...
extension Stripe.Billing.Credit.Balance.Retrieve {
    /// Failure leaf for `Stripe.Billing.Credit.Balance.Client.retrieve`.
    ///
...
extension Stripe.Billing.Credit.Balance.List {
    /// Failure leaf for `Stripe.Billing.Credit.Balance.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
