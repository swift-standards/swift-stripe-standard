//
//  Stripe Billing Test Clocks Types Client Errors.swift
...
extension Stripe.Billing.TestClocks.Create {
    /// Failure leaf for `Stripe.Billing.TestClocks.Client.create`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `TestClock`.
...
extension Stripe.Billing.TestClocks.Retrieve {
    /// Failure leaf for `Stripe.Billing.TestClocks.Client.retrieve`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.TestClocks.List {
    /// Failure leaf for `Stripe.Billing.TestClocks.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.TestClocks.Delete {
    /// Failure leaf for `Stripe.Billing.TestClocks.Client.delete`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Billing.TestClocks.Advance {
    /// Failure leaf for `Stripe.Billing.TestClocks.Client.advance`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-compositions/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
