//
//  Stripe Capital Financing Offer Types Client Errors.swift
...
extension Stripe.Capital.FinancingOffer.Retrieve {
    /// Failure leaf for `Stripe.Capital.FinancingOffer.Client.retrieve`.
    ///
        ...
        Witness.Unimplemented.Representable
    {
        ...
        /// Stripe answered, but the payload did not decode as `Stripe.Capital.FinancingOffer`.
...
extension Stripe.Capital.FinancingOffer.List {
    /// Failure leaf for `Stripe.Capital.FinancingOffer.Client.list`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
...
extension Stripe.Capital.FinancingOffer {
    /// Namespace for the `markDelivered` operation.
    public enum MarkDelivered {}
}

extension Stripe.Capital.FinancingOffer.MarkDelivered {
    /// Failure leaf for `Stripe.Capital.FinancingOffer.Client.markDelivered`.
    ///
    /// Domain leaf of the ruled `Either<Async.Lifecycle.Error, Leaf>` witness-error
    /// shape (swift-foundations/swift-witnesses#3, ratified by comment 5143970225).
    /// Lifecycle facts — shutdown and timeout among them — ride in
